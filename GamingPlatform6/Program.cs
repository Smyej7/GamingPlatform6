...
namespace GamingPlatform6
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // Configure Entity Framework avec la base de donn�es SQLite ou SQL Servervb
            ...
            builder.Services.AddControllersWithViews();// ligne dupliqu�e

            //====App===================================================================
            var app = builder.Build();

            // Utiliser le middleware de v�rification du cookie
            ...
            app.MapHub<Hubs.LobbyHub>("/lobbyHub"); // URL pour acc�der au hub SignalR
